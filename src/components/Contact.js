  ...
  return (
    <section style = {sectionStyles} id ="contactme"> 
      ...
      <div style={contactText}> 
        ...
        <a href="https://drive.google.com/uc?export=download&id=1kh1FvTytxwZiBjesOtL_X2DYrxSH6Nfl" download style={{color:'black',textDecoration: 'none', borderBottom: '5px #7C9ABE solid'}}> download </a>my resume </p>
      </div>
      <Letter />
    </section>
